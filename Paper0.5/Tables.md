...
### Table 1: Pipeline Position (Paper 0, 0.5, 1)
...
- **Rows**:
  - Paper 0: Alignment; multi-source raw; aligned points, signals, unified frame
  - Paper 0.5: Processing and correction; aligned points/signals; processed, corrected signals
  - Paper 1: Signal mapping; processed/aligned signals; unified voxel domain
...
**Table 1**: Pipeline position of Paper 0 (alignment), Paper 0.5 (processing and correction), and Paper 1 (signal mapping).
