...
Paper 0.5 (processing and correction) addresses *what* values to use; Paper 1 (signal mapping) addresses *where* to put them. This separation keeps each paper focused and avoids duplication. Paper 1 continues to state that calibration and correction are prerequisites and references Paper 0.5 for their design and implementation.
