...
- Together they cover noise reduction (smoothing, FFT filter), calibration (Eigen for parameter estimation), and geometric correction (Eigen for distortion model solves), providing a consistent foundation for Paper 2 without duplicating the mapping algorithms of Paper 3.
