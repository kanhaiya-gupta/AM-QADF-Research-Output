...
1. **Figure 1: Pipeline Position (Paper 1 → Paper 2 → Paper 3)**
   - **Location**: Design.md (embedded Mermaid)
   - **Description**: Flowchart showing alignment (Paper 1) → processing and correction (Paper 2) → signal mapping (Paper 3). Processing step includes outlier detection, smoothing, optional FFT, calibration, geometric correction.
...
**Figure 1**: Pipeline position: alignment (Paper 1) → signal processing and correction (Paper 2) → signal mapping (Paper 3).
