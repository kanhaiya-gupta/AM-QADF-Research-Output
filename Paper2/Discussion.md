...
The framework leverages the unified voxel domain (from Paper 1) for spatial-temporal analysis:
...
4. **Coordinate System Accuracy**: Analysis accuracy depends on coordinate system transformation accuracy (from Paper 1)
